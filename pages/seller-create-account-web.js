...
const SellerCreateAccountWeb = () => {
  ...
  const onFrameContainer2Click = useCallback(() => {
    router.push("/seller-verify1-web");
  }, [router]);

  return (
    <div className="w-full relative bg-white1 h-[1286px] overflow-hidden text-left text-base text-white1 font-roboto">
      <div className="absolute top-[0px] left-[0px] [background:linear-gradient(89.28deg,_#7b2334,_#9f3247)] w-[1440px] h-[38px] overflow-hidden text-sm">
      ...
      <div className="absolute top-[62px] left-[100px] w-[1240px] flex flex-row items-center justify-center gap-[40px] text-black">
        <img
      ...
      <div className="absolute top-[134px] left-[0px] bg-light w-[1440px] h-[744px]" />
      <div className="absolute top-[201px] left-[100px] rounded-xl bg-white1 w-[1240px] h-[447px]" />
      <div className="absolute top-[506px] left-[152px] leading-[24px] font-title-16px-regular text-black opacity-[0.4]">
        The code will be sent via sms
      </div>
      <div className="absolute top-[401px] left-[545px] leading-[24px] font-semibold font-title-16px-regular text-accent">
        Send OTP
      </div>
      <div
        className="absolute top-[547px] left-[151px] rounded-43xl [background:linear-gradient(89.28deg,_#7b2334,_#9f3247)] w-[471px] h-[52px] overflow-hidden flex flex-row items-center justify-center py-4 px-[54px] box-border cursor-pointer"
        onClick={onFrameContainer2Click}
      >
        <div className="relative font-medium">Verify</div>
      </div>
      <div className="absolute top-[200px] left-[720px] rounded-tl-none rounded-tr-xl rounded-br-xl rounded-bl-none [background:linear-gradient(89.28deg,_#7b2334,_#9f3247)] w-[620px] h-[448px]" />
      <div className="absolute top-[478px] left-[874px] rounded-43xl bg-gray1-300 w-[311px] h-[37px] overflow-hidden flex flex-row items-center justify-center py-4 px-[54px] box-border text-sm">
        <div className="relative">
          <span className="font-medium">{`Already have an account? `}</span>
          <b className="[text-decoration:underline]">Login here</b>
        </div>
      </div>
      <b className="absolute top-[306px] left-[864px] text-21xl leading-[45px] uppercase inline-block text-white w-[333px] h-[46px]">
        Sell on Bidbuyy
      </b>
      <b className="absolute top-[244px] left-[152px] text-21xl leading-[45px] inline-block text-accent w-[287px] h-[46px]">
        Create Account
      </b>
      <div className="absolute top-[319px] left-[152px] flex flex-col items-start justify-start gap-[8px] text-black font-title-16px-regular">
        <div className="relative leading-[24px] opacity-[0.4]">Phone</div>
        <div className="w-[470px] relative rounded box-border h-[50px] overflow-hidden shrink-0 border-[1px] border-solid border-grey" />
      </div>
      <div className="absolute top-[418px] left-[152px] flex flex-col items-start justify-start gap-[8px] text-black font-title-16px-regular">
        <div className="relative leading-[24px] opacity-[0.4]">OTP</div>
        <div className="flex flex-row items-start justify-start gap-[8px]">
          <div className="w-[50px] relative rounded box-border h-[50px] overflow-hidden shrink-0 border-[1px] border-solid border-grey" />
          <div className="w-[50px] relative rounded box-border h-[50px] overflow-hidden shrink-0 border-[1px] border-solid border-grey" />
          <div className="w-[50px] relative rounded box-border h-[50px] overflow-hidden shrink-0 border-[1px] border-solid border-grey" />
          <div className="w-[50px] relative rounded box-border h-[50px] overflow-hidden shrink-0 border-[1px] border-solid border-grey" />
        </div>
      </div>
      <div className="absolute top-[376px] left-[801px] font-medium text-white text-center inline-block w-[457px]">
        <p className="m-0">
          Ready to showcase your products to a global audience? Create a BidBuyy
          seller account now! Tap into the excitement of auctions, connect with
          eager buyers, and turn your items into extraordinary finds. Join the
          auction adventure today!
        </p>
        <p className="m-0">&nbsp;</p>
      </div>
      <div className="absolute top-[697px] left-[calc(50%_-_721px)] w-[1441px] h-[589px] text-21xl">
...
export default SellerCreateAccountWeb;
