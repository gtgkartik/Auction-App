...
const Product = () => {
  ...
  const onButtonContainerClick = useCallback(() => {
    router.push("/bid-product");
  }, [router]);

  return (
    <div className="w-full relative bg-white1 h-[2137px] overflow-hidden text-left text-base text-black1 font-roboto">
      ...
      <div className="absolute top-[1548px] left-[calc(50%_-_721px)] w-[1441px] h-[589px] text-21xl text-white1">
      ...
      <div className="absolute top-[158px] left-[276px] text-dimgray-100">
        xyz instrument
      </div>
      <img
      ...
      <div className="absolute top-[265px] left-[901px] text-accent">
        Time left 4d 20h (Sat, 02:39 PM)
      </div>
      <div className="absolute top-[350px] left-[901px] text-sm leading-[21px] font-title-16px-regular inline-block w-[373px]">{`PlayStation 5 Controller Skin High quality vinyl with air channel adhesive for easy bubble free install & mess free removal Pressure sensitive. free install & mess free removal Pressure sensitive.`}</div>
      <div className="absolute top-[307px] left-[1029px] text-sm leading-[21px] font-title-16px-regular inline-block w-[373px] h-4">
        (3 bids)
      </div>
      <img
        className="absolute top-[455px] left-[901px] max-h-full w-[400px] opacity-[0.5]"
        alt=""
        src="/underline.svg"
      />
      <div
        className="absolute top-[481px] left-[902px] rounded [background:linear-gradient(89.28deg,_#7b2334,_#9f3247),_#9f3247] w-[336px] flex flex-row items-center justify-center py-2.5 px-12 box-border cursor-pointer text-text font-title-16px-regular"
        onClick={onButtonContainerClick}
      >
        <div className="relative leading-[24px] font-medium">Bid Now</div>
      </div>
      <img
        className="absolute top-[483px] left-[1261px] rounded w-10 h-10 overflow-hidden"
        alt=""
        src="/frame-904.svg"
      />
      <div className="absolute top-[1291px] left-[99px] rounded bg-white w-[1222px] h-[193px] overflow-hidden font-title-16px-regular">
        <img
      ...
      <div className="absolute top-[557px] left-[901px] rounded box-border w-[400px] h-[180px] overflow-hidden font-title-16px-regular border-[1px] border-solid border-gray1-200">
        <img
