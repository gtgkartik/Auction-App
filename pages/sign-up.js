...
const SignUp = () => {
  ...
  return (
    <div className="w-full relative bg-white1 h-[1564px] overflow-hidden text-left text-base text-black font-roboto">
      ...
      <div className="absolute top-[134px] left-[0px] bg-light w-[1440px] h-[931px]" />
      <div className="absolute top-[975px] left-[calc(50%_-_720px)] w-[1441px] h-[589px] text-21xl text-white1">
      ...
      <div className="absolute top-[201px] left-[100px] rounded-xl bg-white1 w-[1240px] h-[710px]" />
      <div className="absolute top-[697px] left-[151px] rounded-43xl [background:linear-gradient(89.28deg,_#7b2334,_#9f3247)] w-[471px] h-[52px] overflow-hidden flex flex-row items-center justify-center py-4 px-[54px] box-border text-white1">
        <div className="relative font-medium">Register</div>
      </div>
      <div className="absolute top-[200px] left-[720px] rounded-tl-none rounded-tr-xl rounded-br-xl rounded-bl-none [background:linear-gradient(89.28deg,_#7b2334,_#9f3247)] w-[620px] h-[711px]" />
      <div className="absolute top-[646px] left-[874px] rounded-43xl bg-gray1-300 w-[311px] h-[37px] overflow-hidden flex flex-row items-center justify-center py-4 px-[54px] box-border text-sm text-white1">
        <div className="relative">
          <span className="font-medium">{`Already have an account? `}</span>
          <b className="[text-decoration:underline]">Login here</b>
        </div>
      </div>
      <b className="absolute top-[419px] left-[885px] text-21xl leading-[45px] inline-block text-white w-72 h-[46px]">
        Create Account
      </b>
      ...
      <div className="absolute top-[632px] left-[187px] leading-[24px] font-title-16px-regular opacity-[0.4]">
      ...
      <div className="absolute top-[524px] left-[152px] flex flex-col items-start justify-start gap-[8px] font-title-16px-regular">
        <div className="relative leading-[24px] opacity-[0.4]">
      ...
      <div className="absolute top-[632px] left-[151px] rounded box-border w-6 h-6 border-[1px] border-solid border-grey" />
      <div className="absolute top-[489px] left-[801px] font-medium text-white text-center inline-block w-[457px]">
        ...
        antiques. Don't miss out on the excitement – sign up now and embark on a
        journey where every bid is a step closer to uncovering extraordinary
        finds! Join the auction adventure today!
      </div>
      <div className="absolute top-[775px] left-[152px] w-[470px] h-[15px]">
        <div className="absolute top-[0px] left-[180px] inline-block w-[107px] h-[15px]">
          Or sign up with
        </div>
        <div className="absolute top-[9.5px] left-[-0.5px] box-border w-[169px] h-px border-t-[1px] border-solid border-light" />
        <div className="absolute top-[9.5px] left-[298.5px] box-border w-[172px] h-px border-t-[1px] border-solid border-light" />
      </div>
      <div className="absolute top-[816px] left-[290px] flex flex-row items-start justify-start gap-[16px]">
        <img
