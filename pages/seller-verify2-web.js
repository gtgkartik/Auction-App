...
const SellerVerify2Web = () => {
  ...
  const onFrameContainer4Click = useCallback(() => {
    router.push("/seller-verify3-web");
  }, [router]);
  ...
  return (
    <div className="w-full relative bg-white1 h-[1455px] overflow-hidden text-left text-base text-white1 font-roboto">
      ...
      <div className="absolute top-[201px] left-[96px] w-[1240px] h-[536px] text-grey font-title-16px-regular">
        <div className="absolute top-[0px] left-[0px] rounded-xl bg-white1 w-[1240px] h-[542px]" />
        <b className="absolute top-[43px] left-[52px] text-21xl leading-[45px] inline-block font-roboto text-accent w-[390px] h-[46px]">
          Address Information
        </b>
        <div className="absolute top-[146px] left-[50px] w-[519px] h-[50px]">
          <div className="absolute top-[0px] left-[0px] rounded bg-whitesmoke-100 w-[519px] h-[50px] overflow-hidden">
            <div className="absolute top-[13px] left-[16px] leading-[24px]">
              Pakistan
            </div>
          </div>
          <img
            className="absolute top-[13px] left-[479px] w-6 h-6 overflow-hidden"
            alt=""
            src="/mingcutedownline.svg"
          />
        </div>
        <div className="absolute top-[150px] left-[611px] w-[519px] h-[50px]">
          <div className="absolute top-[0px] left-[0px] rounded bg-whitesmoke-100 w-[519px] h-[50px] overflow-hidden">
            <div className="absolute top-[13px] left-[16px] leading-[24px]">
              Select State
            </div>
        ...
        <div className="absolute top-[214px] left-[52px] w-[519px] h-[50px]">
          <div className="absolute top-[0px] left-[0px] rounded bg-whitesmoke-100 w-[519px] h-[50px] overflow-hidden">
            <div className="absolute top-[13px] left-[16px] leading-[24px]">
              Select Area
            </div>
        ...
        <div className="absolute top-[282px] left-[50px] w-[1080px] h-[141px]">
          <div className="absolute top-[0px] left-[0px] rounded box-border w-[1080px] h-[141px] overflow-hidden border-[1px] border-solid border-grey" />
          <div className="absolute top-[13px] left-[16px] leading-[24px]">
            Enter complete address here
          </div>
        </div>
        <div
          className="absolute top-[441px] left-[50px] rounded-43xl [background:linear-gradient(89.28deg,_#7b2334,_#9f3247)] w-[186px] h-[52px] overflow-hidden flex flex-row items-center justify-center py-4 px-[54px] box-border cursor-pointer text-white1 font-roboto"
...
export default SellerVerify2Web;
