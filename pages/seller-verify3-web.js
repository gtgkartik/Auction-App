...
const SellerVerify3Web = () => {
  ...
  const onFrameContainer1Click = useCallback(() => {
    router.push("/seller-add-product-web");
  }, [router]);
  ...
  return (
    <div className="w-full relative bg-white1 h-[1455px] overflow-hidden text-left text-base text-white1 font-roboto">
      ...
      <div className="absolute top-[201px] left-[96px] w-[1240px] h-[536px] text-black font-title-16px-regular">
        ...
        <div className="absolute top-[213px] left-[52px] w-[519px] h-[50px] text-grey">
        ...
        <div
          className="absolute top-[349px] left-[52px] rounded-43xl [background:linear-gradient(89.28deg,_#7b2334,_#9f3247)] w-[186px] h-[52px] overflow-hidden flex flex-row items-center justify-center py-4 px-[54px] box-border cursor-pointer text-white1 font-roboto"
          onClick={onFrameContainer1Click}
        >
          <div className="relative font-medium">Next</div>
        </div>
        <div className="absolute top-[145px] left-[52px] w-[519px] h-[50px]">
        ...
        <div className="absolute top-[281px] left-[52px] w-[519px] h-[50px]">
          <div className="absolute top-[0px] left-[0px] rounded box-border w-[519px] h-[50px] overflow-hidden border-[1px] border-solid border-grey">
            <div className="absolute top-[13px] left-[10px] leading-[24px] opacity-[0.4]">
              Branch code
            </div>
        ...
        <div className="absolute top-[145px] left-[613px] w-[519px] h-[50px]">
          <div className="absolute top-[0px] left-[0px] rounded box-border w-[519px] h-[50px] overflow-hidden border-[1px] border-solid border-grey">
            <div className="absolute top-[13px] left-[10px] leading-[24px] opacity-[0.4]">
              IBAN
            </div>
        ...
        <div className="absolute top-[213px] left-[613px] w-[519px] h-[50px]">
          <div className="absolute top-[0px] left-[0px] rounded box-border w-[519px] h-[50px] overflow-hidden border-[1px] border-solid border-grey">
            <div className="absolute top-[13px] left-[10px] leading-[24px] opacity-[0.4]">
              Account Number
            </div>
...
export default SellerVerify3Web;
